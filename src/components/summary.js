...
//But here are some prop drilling issues on large application. so, we need to use it on a simple application;where are main focus is to reduce the code repeatation and make the debug easier.